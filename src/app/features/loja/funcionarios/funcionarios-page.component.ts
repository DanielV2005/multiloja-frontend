...
export class FuncionariosPageComponent implements OnInit {
  ...
  desativarFuncionario(func: FuncionarioListItem): void {
    ...
    this.dialog.open(DesativarFuncionarioConfirmDialogComponent, {
      autoFocus: false,
      data: { nome: func.nome },
    })
    .afterClosed()
...
interface DesativarFuncionarioConfirmData {
  nome: string;
}

@Component({
  standalone: true,
  selector: 'app-desativar-funcionario-confirm-dialog',
    ...
    <section class="dialog-card">
      <header class="dialog-header">
        ...
        <div class="title">
          ...
          <p>
            Deseja desativar o funcionário "<strong>{{ data.nome }}</strong>"?
          </p>
        </div>
      </header>
...
export class DesativarFuncionarioConfirmDialogComponent {
  constructor(
    private ref: MatDialogRef<DesativarFuncionarioConfirmDialogComponent, boolean>,
    @Inject(MAT_DIALOG_DATA) public data: DesativarFuncionarioConfirmData,
  ) {}
